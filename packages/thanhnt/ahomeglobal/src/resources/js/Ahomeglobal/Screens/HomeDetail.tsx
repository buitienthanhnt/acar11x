	...
	return (
		<>
			...
			<div className='container mx-auto p-2 rounded-md min-h-screen space-y-2 py-4'>
				...
				{
					rate && <Rating value={(rate.value as unknown as number > 5 ? 5 : rate.value) as unknown as number} placeholder={'rate'}
						onResize={undefined}
				...
				{homeDetail.rooms.length ?
					<div className='space-y-2 grid grid-cols-1 lg:grid-cols-5 p-1 gap-x-1'>
				...
				{location && <div className='grid grid-cols-1 lg:grid-cols-2'>
