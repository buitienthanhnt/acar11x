...
namespace Thanhnt\Abookglobal\Services;

use ErrorException;
use Stripe\Charge;
use Stripe\Checkout\Session;
use Stripe\Stripe;
use Thanhnt\Abookglobal\Api\CartApi as ApiCartApi;
...
final class StripeService
{
	...
	public function createCartItem($params, $absolute = false)
	{
		...
		try {
			 ...
			 */
			BookExpectOrder::forceDestroy($expectOrder->id);
